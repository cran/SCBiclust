...
#' @param sc should the \code{\link[sigclust]{sigclust}} test be used? (default=TRUE)
#'
...
#' distribution for feature weights. Use of the \code{\link[sigclust]{sigclust}} algorithm  to test the strength of the identified clusters is optional in this
